...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002054700920').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# auth_channel means force subscribe channel.
auth_channel = environ.get('AUTH_CHANNEL', '-1002138045286') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://bhawanishankarborana:bhawanishankar@cluster0.ou8pg16.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Bsborana') # owner username without @

# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+Kzo_2M-XqCcyOGU1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Updatechannel24')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/howtoopenurlshorlink')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Bsborana') # Support Chat Link Without https:// or @
...
# Shortlink Info
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'api.cloaking.link')
SHORTLINK_API = environ.get('SHORTLINK_API', '52c2b0051b9c6547b93fdeea9efb3de51eb89c8f')
